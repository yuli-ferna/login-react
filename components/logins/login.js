...
import { Form, Icon, Input, Button, Row, Col, Layout, Menu, Modal, InputNumber } from "antd";
...
class Login extends React.Component {
    render() {
        ...
        const donateModalVisible = false;
            ...
            >
                ...
                <Menu theme="dark" mode="horizontal" >
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', lineHeight: '64px' }}>
                        <img src={props.logoMini} style={{ width: 35, margin: 'auto', marginRight: '10px' }}></img>
                    ...
                    <Button
                        ...
                        <InputNumber
                            ...
                            min = {1}
                        />
                        <select id = "selecDonateValues" onchange = "updateDonation()"></select> 
                        <StripeCheckout stripeKey={STRIPE_SECRET_KEY} 
                        token={makeDonation}
                        name="Ozone Universe"
                        amount={product.price * 100}>
                            ...
                            // onClick = { () => setDonateModalVisible(false)}
                            >
                                Donate
                        </Button>
                        </StripeCheckout>,
                    ...
                    <Row>
                        ...
                        >
                            ...
                            <span className={classes.rightSubAction}>
                                ...
                                <a src="/recover-password">Forgot password</a>
                            </span>
                            </Form.Item>
                            {/* {displayError && (
                            // <Form.Item>
                ...
                >
                    ...
                    >
                        ...
                        {/* {getFieldDecorator("email_responsive", {
                            ...
                            <Input
                            className={!props.metaburn ? classes.input :  classes.inputMetaburn}
                            prefix={
                                <Icon
                                type="user"
                                style={{ color: "rgba(0,0,0,.25)" }}
                        ...
                        <span className={classes.leftSubAction}>
                            {/* <Link to="/register">Register</Link> */}
                            {/* <Link smooth to="/login#register-form">Register</Link> */}
                            <a src="/login#register-form">Register</a>
                        </span>
                ...
                >
                    ...
                    <Col span={8} xs={20} sm={20} md={20} lg={20} xl={!props.metaburn ? 8 : 7} xxl={!props.metaburn ? 8 : 7}
                    className={classes.form}
                    style={{
                        marginTop: 40, padding: "1.5em", display: "flex", flexDirection: "column", justifyContent: "center"
                    }}
                    className={`${props.metaburn ? "background-card-metaburn" : "background-white"}`}
                    id="register-form"
                    >
                    {!props.metaburn &&
                        <div className="ant-row-flex ant-row-flex-space-around ant-row-flex-middle ant-form-item">
